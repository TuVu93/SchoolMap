...
<body>
  <div class="login-card">
	<?php
		...
		<p><label for="password">Password: </label><input type="password" size="100" name="password" id="password"/></p>
		<p><input type="submit" name="login" class="login login-submit" id="submit" value="Submit"/>
		</form>
EOD;
