...
<head>
	...
	function search()
	{
		...
		if (name.length == 0) { 
			...
			jQuery.ajax({
            url: 'php/search.php', //Call search.php
            type: "POST",
			datatype: "json",
            data: ({name: name}),
            success: function(data){
...
<div id=header>
	<div class="wrapper">
		...
		<form method="get" action="javascript:search()" id="searchForm" style="width: 100%; margin-right: 35px;"> 
			<input type="text" id="searchBox" name="name" value="" onfocus="this.value = '';"  style="width: auto; height: 22px;"> 
...
<div id=footer>
	<div class="wrapper">
		<img class="footlogo" src="/images/footer-logo.png">
		<p class="address">
			<b>Lapland UAS</b></br>
			Jokiväylä 11 C</br>
